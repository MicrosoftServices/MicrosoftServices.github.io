[index.html](https://github.com/user-attachments/files/24143257/index.html)
...
<head>
    ...
    <title>Liceo Técnico Manuel Del Cabral - Portal Institucional</title>
    ...
    <style>
        ...
        * {
        ...
        /* Hero Section */
        .hero {
            background: linear-gradient(rgba(44, 62, 80, 0.8), rgba(44, 62, 80, 0.9)), url('https://pbs.twimg.com/media/DDCNM4GUIAANF3K.jpg');
        ...
        /* Sección Nosotros */
        .nosotros-cta {
            background: url('https://elsoldelaflorida.com/wp-content/uploads/2017/06/liceo-INAUGURADO.jpg');
            background-size: cover;
            background-position: center;
            color: white;
            text-align: center;
        ...
        .service-card p {
         ...
         /* Hero Section */
        .hero2 {
            background: linear-gradient(rgba(44, 62, 80, 0.8), rgba(44, 62, 80, 0.9)), url('https://revistaglobal.org/wp-content/uploads/2023/09/biblioteca-13102018-pixabay-1024x682-1.jpeg');
            background-size: cover;
            background-position: center;
            color: var(--color-white);
            padding: 300px 0 ;
...
<body>
    ...
    <section class="hero" id="inicio">
        <div class="container">
            <h2>Formando Líderes Técnicos para el Futuro</h2>
            <p>El Liceo Técnico Manuel Del Cabral es una institución educativa de vanguardia que combina excelencia académica con formación técnica especializada, preparando a nuestros estudiantes para los desafíos del siglo XXI.</p>
            <div class="cta-buttons">
                <a href="#nosotros" class="btn">Conoce Nuestra Institución</a>
  ...
  <!-- Slider -->
    <section id="nosotros" class="containerliceo">
        <div class="container">
            <div class="section-title">
                <h2>Conoce Nuestra Institución</h2>
                <p>Descubre el Liceo Técnico Manuel Del Cabral a través de nuestras instalaciones y actividades</p>
            </div>
            
            <div class="slider-container">
                <div class="slider" id="slider">
                    <div class="slide">
                        <img src="https://cdn.lacronica.do/wp-content/uploads/2017/06/Centro-educativo-Boca-Chica-jun-25-2017.jpg" alt="Instalaciones del liceo">
                        <div class="slide-content">
                            <h3>Instalaciones Modernas</h3>
                            <p>Contamos con laboratorios y talleres equipados con tecnología de punta para la formación técnica de nuestros estudiantes.</p>
                            
                        </div>
                    </div>
                    <div class="slide">
                        <img src="https://www.senadord.gob.do/wp-content/uploads/2023/03/WhatsApp-Image-2023-03-29-at-8.45.51-AM-3.jpeg" alt="Estudiantes en clase">
                        <div class="slide-content">
                            <h3>Excelencia Académica</h3>
                            <p>Nuestro equipo docente altamente calificado garantiza una educación de calidad que combina teoría y práctica.</p>
                            
                        </div>
                    </div>
                    <div class="slide">
                        <img src="https://mdelcabralfeyalegria.weebly.com/uploads/1/1/9/2/119213734/27503305-1708829812517095-2686266035366501638-o_orig.jpg" alt="Actividades extracurriculares">
                        <div class="slide-content">
                            <h3>Formación Integral</h3>
                            <p>Promovemos el desarrollo de habilidades sociales, artísticas y deportivas para una formación completa de nuestros estudiantes.</p>
                           
                        </div>
                    </div>
                </div>
                <button class="slider-arrow prev" id="prev"><i class="fas fa-chevron-left"></i></button>
                <button class="slider-arrow next" id="next"><i class="fas fa-chevron-right"></i></button>
    ...
    <!-- Sección Nosotros -->
    <section id="nosotros-cta">
        <div class="container">
            <div class="nosotros-cta">
                <h2>Descubre Más Sobre Nuestra Institución</h2>
                <a href="../html/nosotros.html" class="btn btn-accent" style="font-size: 1.2rem; padding: 15px 30px;">Ir a la Página Nosotros</a>
                
                <div class="nosotros-features">
                    <div class="nosotros-feature">
                        <i class="fas fa-history"></i>
                        <h3>Nuestra Historia</h3>
                        <p>Más de 30 años formando técnicos profesionales</p>
                    </div>
                    <div class="nosotros-feature">
                        <i class="fas fa-users"></i>
                        <h3>Nuestro Equipo</h3>
                        <p>Docentes altamente calificados y comprometidos</p>
                    </div>
                    <div class="nosotros-feature">
                        <i class="fas fa-chart-line"></i>
                        <h3>Logros</h3>
                        <p>Reconocimientos y premios a la excelencia educativa</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="hero2" id="inicio2">
        <div class="container">
            <h2>Conoce Nuestra Biblioteca Virtual</h2>
            <p>La biblioteca es un espacio de aprendizaje y apoyo académico donde los estudiantes pueden acceder a libros y materiales de estudio, además de contar con un ambiente tranquilo para leer, investigar y desarrollar sus habilidades escolares.</p>
            <div class="cta-buttons2">
                <a href="../html/biblioteca.html" class="btn2">Ver más</a>
            </div>
        </div>
    </section>
<br>
    ...
    <section id="servicios">
        <div class="container">
            <div class="section-title">
                ...
                <p>Ofrecemos una amplia gama de especialidades técnicas que preparan a nuestros estudiantes para el mundo laboral</p>
            </div>
            ...
            <div class="services-grid">
                <div class="service-card">
                    ...
                    <h3>Informática</h3>
                    <p>Formación en desarrollo de software y soporte técnico con tecnología de vanguardia.</p>
                    <a href="../html/informatica.html" class="btn btn-accent">Más Información</a>
                </div>
                ...
                <div class="service-card">
                    ...
                    <h3>Mercadeo</h3>
                    <p>Especialización en circuitos, automatización y sistemas electrónicos industriales.</p>
                    <a href="../html/Mercadeo.html" class="btn btn-accent">Más Información</a>
                </div>
                ...
                <div class="service-card">
                    ...
                    <h3>Tributaria</h3>
                    <p>Formación en mantenimiento, diseño y operación de maquinaria industrial.</p>
                    <a href="../html/Tributaria.html" class="btn btn-accent">Más Información</a>
                </div>
                ...
                <div class="service-card">
                    ...
                    <h3>Artes Aplicada</h3>
                    <p>Preparación en gestión empresarial, contabilidad y recursos humanos.</p>
                    <a href="../html/arte.html" class="btn btn-accent">Más Información</a>
                </div>
            </div>
        </div>
    </section>
    ...
    document.querySelectorAll('a[href^="#"]').forEach(anchor => {
     ...
     <script>
        ...
        document.querySelectorAll('form[id^="login-form"]').forEach(form => {
            form.addEventListener('submit', function(e) {
                e.preventDefault();
                alert('Inicio de sesión simulado. En una implementación real, esto conectaría con un servidor de autenticación.');
            });
        });
